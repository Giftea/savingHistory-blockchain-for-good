 ...
 * @notice For future upgrades, do not change SAVEHDelegateStorageV1. Create a new
 * contract which implements SAVEHDelegateStorageV1 and following the naming convention
 * SAVEHDelegateStorageVX.
 */
contract SAVEHDelegateStorageV1 {
